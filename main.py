...
class managehotel:
    ...
    def roomrent(self):#sel1353
        ...
        print ("1.  LOW CLASS---->2000")

        print ("2.  MEDIUM CLASS---->3000")

        print ("3.  HIGH CLASS---->4000")
        ...
        if(x==1):
            ...
            print ("you have choose Low class room")

            self.s=2000*n

        elif (x==2):

            print ("you have choose Medium classs room")

            self.s=3000*n

        elif (x==3):

            print ("you have choose High Class room")
    ...
    def foodpurchased(self):
        ...
        print("1.Naan>100","2.Drinks----->50","3.Breakfast---   >90","4.Lunch---->110","5.Dinner--->150","6.Exit")
...
# Here define a main function to call above functions.
def main():
    a=managehotel()
